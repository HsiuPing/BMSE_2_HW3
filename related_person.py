...
class RelatedPerson( object ):
    ...
    def __str__( self ):  # pragma: no cover
        ...
        # Hsiu-Ping: no need to report missing in both __repr__ and __str__
    ...
    def remove_father( self ):
        ...
        # Hsiu-Ping: Here is a bug. We should set self.father == None after removing
        self.father = None
    ...
    def add_child( self, child ):
        ...
        # Hsiu-Ping: add an condition. A person cannot add himself/herself as a child
        if child == self:
            raise RelatedPersonError("'{}' cannot add him/herself as a child".format(
                child.name, self.name))

        # Hsiu-Ping: This function should add the child the attribute "children"
        self.children.add(child)

        if self.gender == Gender.FEMALE:
            # Hsiu-Ping: here should be set_mother
    ...
    def ancestors( self, min_depth, max_depth=None ):
        ...
        # Hsiu-Ping: Here is a redundant variable and should be fixed
        #useless_variable = 3
    ...
    def all_ancestors( self ):
        ...
        '''
        # Hsiu-Ping: this should be 1. all_ancestors should include parents
